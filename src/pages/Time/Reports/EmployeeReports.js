    ...
    return (
        <div>
            <MuiPickersUtilsProvider utils={DateFnsUtils}>
                ...
                <Grid container>
                    <text style={{marginRight:30}}>Employee *</text>
                ...
                <Grid container>
                    ...
                    <text style={{marginRight:30}}>Activity Name *</text>
                    <TextareaAutosize aria-label="empty textarea" placeholder="--No Project Activities--" />
                </Grid> <br/><br/>
                <Grid container  >
