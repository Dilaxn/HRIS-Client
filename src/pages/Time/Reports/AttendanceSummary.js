    ...
    return (
        <div>
            <MuiPickersUtilsProvider utils={DateFnsUtils}>
                <h1>Attendance Total Summary Report</h1>
                <Grid container>
                    <text style={{marginRight: 30}}>Employee Name *</text>
                    <TextareaAutosize aria-label="empty textarea" placeholder="Type for hint... "/>
                </Grid> <br/><br/>
                <Grid container>
                    <text style={{marginRight: 30}}>Job Title </text>
                    <TextareaAutosize aria-label="empty textarea" placeholder="All"/>
                </Grid> <br/><br/>
                <Grid container>
                    <text style={{marginRight: 30}}>Sub Unit </text>
                    <TextareaAutosize aria-label="empty textarea" placeholder="All"/>
                </Grid> <br/><br/>
                <Grid container>
                    <text style={{marginRight: 30}}>Employment Status</text>
                    <TextareaAutosize aria-label="empty textarea" placeholder="All"/>
                </Grid> <br/><br/>
                <Grid container>
