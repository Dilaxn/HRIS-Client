    ...
    const options = {
        ...
        onRowClick: async (rowData) => {
            ...
            if (answer) {
                ...
                return axios.delete('/api/employees/me/work_experiences', {
                    headers: {
    ...
    const options2 = {
        ...
        onRowClick: async (rowData) => {
            ...
            if (answer) {
                ...
                let x = [rowData[3]]
                let educations = [x[0]]
                return axios.delete('/api/employees/me/education', {
                    headers: {
                        'Authorization': `Bearer ${tokenString}`,
                        'Content-Type': 'application/json',
                    },
    ...
    const options3 = {
        ...
        onRowClick: async (rowData) => {
            ...
            if (answer) {
                ...
                return axios.delete('/api/employees/me/skills', {
                    headers: {
                        'Authorization': `Bearer ${tokenString}`,
                        'Content-Type': 'application/json',
                    },
    ...
    const options4 = {
        ...
        onRowClick: async (rowData) => {
            ...
            if (answer) {
                ...
                return axios.delete('/api/employees/me/languages', {
                    headers: {
                        'Authorization': `Bearer ${tokenString}`,
                        'Content-Type': 'application/json',
                    },
    ...
    const options5 = {
        ...
        onRowClick: async (rowData) => {
            ...
            if (answer) {
                ...
                return axios.delete('/api/employees/me/licenses', {
                    headers: {
                        'Authorization': `Bearer ${tokenString}`,
                        'Content-Type': 'application/json',
                    },
                        ...
                        <form>
                            ...
                            <Button style={{
                                ...
                                onClick={() => {
                                    ...
                                    return axios.post('/api/employees/me/work_experiences', dDetails, {
                                        headers: {
                                            Authorization: `Bearer ${tokenString}`,
                                            'content-type': 'application/json'
                                        }
...
select
                            ...
                            <Button style={{
                                ...
                                onClick={() => {
                                    ...
                                    const dDetails = clean(dependent)
                                    console.log(dependent)
                                    return axios.post('/api/employees/me/education', dDetails, {
                                        headers: {
                                            Authorization: `Bearer ${tokenString}`,
                                            'content-type': 'application/json'
                                        }
                        ...
                        <form>
                            ...
                            <Button style={{
                                ...
                                onClick={() => {
                                    ...
                                    const dDetails = clean(dependent)
                                    console.log(dependent)
                                    return axios.post('/api/employees/me/skills', dDetails, {
                                        headers: {
                                            Authorization: `Bearer ${tokenString}`,
                                            'content-type': 'application/json'
                                        }
                        ...
                        <form>
                            ...
                            <Button style={{
                                ...
                                onClick={() => {
                                    ...
                                    const dDetails = clean(dependent)
                                    console.log(dependent)
                                    return axios.post('/api/employees/me/languages', dDetails, {
                                        headers: {
                                            Authorization: `Bearer ${tokenString}`,
                                            'content-type': 'application/json'
                                        }
                        ...
                        <form>
                            ...
                            <Button style={{
                                ...
                                onClick={() => {
                                    ...
                                    const dDetails = clean(dependent)
                                    console.log(dependent)
                                    return axios.post('/api/employees/me/licenses', dDetails, {
                                        headers: {
                                            Authorization: `Bearer ${tokenString}`,
                                            'content-type': 'application/json'
                                        }
